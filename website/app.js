...
(function () {
  ...
  var FR = {
    ...
    'tour.demo.omarchy01': 'Sur Arch, le même cadre répond pour <span class="mono">pacman</span> et <span class="mono">yay</span>, les dépôts et l’AUR dans une seule liste. Aucun enregistrement n’en existe encore.',
    ...
    'tour.demo.omarchy04': 'La même bascule <kbd>^R</kbd> fonctionne sur Arch, sur les dépôts et l’AUR à la fois. Sa capture n’est pas encore enregistrée.',
    ...
    'tour.demo.mac05': 'L’installation par la fenêtre se comporte pareil sur macOS, avec brew qui répond. Aucun enregistrement n’en existe encore — basculez sur Windows ci-dessus pour en voir un, le geste est identique.',
    ...
    'tour.demo.omarchy05': 'Pareil sur Arch, avec yay qui répond — ses propres questions de l’AUR relayées telles quelles, puisque jigger ne fait plus rien une fois la ligne lancée. Aucune capture n’en est encore enregistrée.',
    ...
    'tour.demo.omarchy02': 'La façade se comporte pareil, avec un détail qui appartient à Arch : pacman et yay sont deux portes sur la même base, aussi <span class="mono">jg</span> liste-t-il vos paquets <strong>une</strong> fois, jamais deux. Aucun enregistrement n’en existe encore.',
    ...
    'tour.demo.mac06': 'C’est pareil sur macOS, où c’est brew qui met à jour. Sa capture n’est pas encore enregistrée.',
    ...
    'tour.demo.omarchy06': 'Même geste sur Arch. À noter que yay pilote et que pacman ne fait que lire, ce qui explique que <span class="mono">jg install --pm pacman</span> n’existe pas tant que yay est installé. Sa capture n’est pas encore enregistrée.',
    ...
    'tour.demo.omarchy03': 'Rien ne change sur Arch : le sélecteur lit <span class="mono">~/.ssh/config</span> et rien d’autre. Aucun n’a encore été pris sur Omarchy.',
