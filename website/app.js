...
(function () {
  ...
  var FR = {
    ...
    'use.linux.p': 'Arch et Omarchy fonctionnent déjà — pacman et yay, même fenêtre, mêmes verbes. Leurs captures ne sont pas encore enregistrées, donc cette page ne les déroule pas. La documentation, si.',
    ...
    'dia3.eyebrow': 'UN VERBE, QUATRE PORTES',
